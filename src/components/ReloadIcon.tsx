...
function ReloadIcon({ onClick, size }: ReloadIconProps) {
  return (
    <button
      onClick={onClick}
      className="flex items-center justify-center p-2 rounded-full transition-transform duration-300 ease-in-out hover:scale-125 active:scale-95 colo"
    >
      <svg
